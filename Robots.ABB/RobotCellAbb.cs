...
namespace Robots
{
    ...
    {
        public RobotCellAbb() : base("", Manufacturers.ABB, null, null, Plane.WorldXY, null)
        {
            throw new Exception("Using default constructor.");
        }
        public RobotCellAbb(string name, List<MechanicalGroup> mechanicalGroups, IO io, Plane basePlane, Mesh environment) : base(name, Manufacturers.ABB, mechanicalGroups, io, basePlane, environment)
        {
        ...
        */
        ...
        public static string GetRobotSystemType()
        {
            return "ABB";
        }
        public override double[] PlaneToNumbers(Plane plane) => Util.PlaneToQuaternion(plane);
